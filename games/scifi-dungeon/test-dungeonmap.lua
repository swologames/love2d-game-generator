-- test-dungeonmap.lua
-- Simple test script to verify DungeonMap loading
-- Run from scifi-dungeon directory: lua test-dungeonmap.lua

-- Mock love.filesystem for standalone testing
if not love then
  love = {}
  love.filesystem = {}
